# this is just example set according to project
...
# from email_assistant.tools.plateform_ab.run_ingest import fetch_and_process_emails  # set accodig to agent
...
class JobKickoff:
    ...
    url: str = "http://127.0.0.1:2024"   # change with production url
